...
st.title("Selamat datang di Webiste Pengecekan Kualitas Susu")
st.image(image, use_column_width=True)

# checking the data
st.write("Aplikasi ini Bertujuan Untuk Membantu Mengecek Kualitas Susu")
...
turbidity1 = st.radio(
    "Bagaimana Tingkat Kekeruhan?",
    ('Tinggi', 'Rendah'))

if turbidity1 == 'Tinggi':
    turbidity = 1
else:
    turbidity = 0
